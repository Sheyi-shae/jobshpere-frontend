...
export default function InternshipJobs({ data,isLoading}) {
  ...
  //filter internship jobs from data
 const internshipJobs = data?.filter((job) => job.type === "internship")
   // Filter jobs based on search criteria
 const filteredJobs = useMemo(() => {
  let filtered = internshipJobs
  ...
  return filtered
}, [internshipJobs, searchTerm, location, jobType, salaryRange])
                                  ...
                                  {!searchTerm && filteredJobs?.length === 0 && (
                                    <Card>
                                      <CardContent className="pt-6">
                                        <div className="text-center py-12">
                                          <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                            <FolderOpen className="h-8 w-8 text-blue-800 animate-pulse" />
                                          </div>
