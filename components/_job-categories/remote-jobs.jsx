...
export default function RemoteJobs({ data,isLoading}) {
  ...
  //filter remote jobs from data
 const remoteJobs = data?.filter((job) => job.type === "remote")
   // Filter jobs based on search criteria
 const filteredJobs = useMemo(() => {
  let filtered = remoteJobs
  ...
  return filtered
}, [remoteJobs, searchTerm, location, jobType, salaryRange])
