...
export function MobileJobCard({ job,  onApply }) {
 ...
 const slug = job.company?.slug 
  ...
  //push to job details page on click
  const jobDetails = () => {
  ...
  return (
    <Card
      ref={ref}
      className={`cursor-pointer grid lg:hidden  transition-all duration-300 transform hover:scale-[1.02]
         hover:shadow-xl bg-gradient-to-br from-white to-gray-50`}
      onClick={jobDetails}
    >
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              <Avatar className="w-12 h-12 border-2 border-white shadow-md">
                <AvatarImage src={job.company.logo || "/placeholder.svg"} alt={job.company} />
