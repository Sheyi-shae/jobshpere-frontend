...
export default function ContractJobs({ data,isLoading}) {
  ...
  //filter contract jobs from data
 const contractJobs = data?.filter((job) => job.type === "contract")
   // Filter jobs based on search criteria
 const filteredJobs = useMemo(() => {
  let filtered = contractJobs
  ...
  return filtered
}, [contractJobs, searchTerm, location, jobType, salaryRange])
